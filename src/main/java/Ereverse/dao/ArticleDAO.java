...
public class ArticleDAO {
    /**
     * Méthode pour obtenir un article à partir de son identifiant dans la bdd
     * @param id_article : identifiant de l'article dans la bdd
     * @return : L'objet article correspondant à l'article de la bdd
     */
    ...
    public static void AjoutArticle(String reference, String saveur, String description, double prix, String image, int id_type, int id_gamme, int id_couleur, String nom){
        Connection connection = null;
        PreparedStatement statement = null;
        try {
            connection = ServiceConnexionBDD.getConnection();
            ...
            statement.execute();
            System.out.println("Article '" + nom + "' de référence: " + reference + " rajouté");
        } catch (SQLException e) {
            e.printStackTrace();
        }
    }
